...
package com.example.michael.obdshow.view;
...
//			chart.hideBorder();
	...
	public void addAxis()
	{
		...
		float rper = MathHelper.getInstance().div(1, 5); //相当于40%	//270, 4
	...
	private void addAttrInfo()
	{
		...
		plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, "Km/H", 0.7f, paintBT2);
	}
