...
import me.michaeljiang.obdsystem.model.Point;
import me.michaeljiang.obdsystem.util.AppSetting;
import me.michaeljiang.obdsystem.util.CoordinateConversion;

public class NavigationFragment extends Fragment implements  BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener, OnGetGeoCoderResultListener {
...
//            GPSReceiver();
    ...
    public void GPSReceiver() {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) !=
            ...
            Toast.makeText(getActivity(), "没有权限", Toast.LENGTH_LONG);
            return;
        } else {
            //获取所有可用的位置提供器
